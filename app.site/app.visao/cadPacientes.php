            <?php include_once 'navHome.php'; ?>
                ...
                <form id="cadPacientes" class="col s12 m6 l4 hoverable" method="post">
                <fieldset id="informacoes">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6 l6">
                            <input type="text" name="nomePac" id="nomePac" maxlength="80" required >
                            <label for="nomePac">Nome do paciente</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="contato" id="contato" maxlength="40" required >
                        ...
                        <div class="input-field col s12 m6 l4">
                            <input type="text" name="titulo" id="titulo" maxlength="14">
                            <label for="titulo">T&iacute;tulo Eleitoral</label>
                        </div>
                        <div class="input-field col s12 m6 l1">
                            <input type="text" name="zona" id="zona" maxlength="3">
                            <label for="zona">Zona</label>
                        </div>
                        <div class="input-field col s12 m6 l1">
                            <input type="text" name="sessao" id="sessao" maxlength="4">
                        ...
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="alistamento" id="alistamento" maxlength="18">
                            <label for="alistamento">Alistamento</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="cnh" id="cnh" maxlength="13">
                            <label for="cnh">Habilita&ccedil;&atilde;o</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="categoria" id="categoria" maxlength="4">
                            <label for="categoria">Categoria</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="date" name="dtCnh" id="dtCnh" maxlength="10">
                            <label for="dtCnh">Dt. Emiss&atilde;o</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="ctps" id="ctps" maxlength="10">
                            <label for="dtps">Carteira de Trabalho</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="serie" id="serie" maxlength="10">
                        ...
                        <div class="input-field col s12 m6 l3">
                            <input type="date" name="dtCtps" id="dtCtps" maxlength="10">
                            <label for="dtCtps">Dt. Emiss&atilde;o</label>
                        </div>
                        <div class="input-field col s12 m6 l3">
                            <input type="text" name="pis" id="pis" maxlength="14">
